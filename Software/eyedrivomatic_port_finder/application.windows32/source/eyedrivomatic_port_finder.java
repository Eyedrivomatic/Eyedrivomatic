...
public class eyedrivomatic_port_finder extends PApplet {
...
public void writeConfig(String value) { //writes a value to the config file
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "eyedrivomatic_port_finder" };
    if (passedArgs != null) {
