...
namespace Eyedrivomatic.Device.Serial.UnitTests
{
    ...
    public class StatusMessageProcessorTests
    {
        ...
        public void TestStatusMessageProcessor_Works()
        {
            ...
            Assert.That(receievedArgs.Switches[1], Is.False);
            Assert.That(receievedArgs.Switches[2], Is.True);
            Assert.That(receievedArgs.Switches[3], Is.False);
            Assert.That(receievedArgs.Switches[4], Is.False);
        }
