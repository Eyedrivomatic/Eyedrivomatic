...
namespace Eyedrivomatic.Device.Mk1.Models
{
    ...
    internal class Mk1DeviceStatus : BindableBase, IDeviceStatus
    {
        ...
        internal Mk1DeviceStatus(IStatusMessageSource statusMessageSource, ISwitchStatus switchStatus, [Import(nameof(IDeviceCommands.GetStatus))] Func<Task<bool>> getStatusCommand)
        {
