...
namespace Eyedrivomatic.Device.Mk1.Models
{
    ...
    internal class Mk1DeviceSettings : BindableBase, IDeviceSettings
    {
        ...
        public uint SwitchCount => 3;

        [ImportingConstructor]
        internal Mk1DeviceSettings(
            ...
            ISettingsMessageSource settingsMessageSource)
        {
            ...
            _messageHandlers = new Dictionary<string, Action<string>>
            {
                ...
                { SettingNames.Switch1Default, s => SetProperty(ref _switchDefaults[0], s == "ON", nameof(SwitchDefaults))},
                { SettingNames.Switch2Default, s => SetProperty(ref _switchDefaults[1], s == "ON", nameof(SwitchDefaults))},
                { SettingNames.Switch3Default, s => SetProperty(ref _switchDefaults[2], s == "ON", nameof(SwitchDefaults))},
            };
        ...
        public bool?[] SwitchDefaults { get; } = new bool?[3];
