...
namespace Eyedrivomatic.Common.UI
{
    ...
    {
        public static readonly PixelShader GrayscalePixelShader = new PixelShader() { UriSource = new Uri(@"pack://application:,,,/Eyedrivomatic.Common.UI;component/GrayscaleEffect.ps") };
