...
{
    [Export(typeof(IConnectionEnumerationService))]
    public class ConnectionEnumerationService : IConnectionEnumerationService
    {
        private readonly IDeviceConnectionFactory _connectionFactory;
        private readonly IEnumerable<IDeviceInfo> _infos;

        [ImportingConstructor]
        public ConnectionEnumerationService(IDeviceConnectionFactory connectionFactory, [ImportMany] IEnumerable<IDeviceInfo> infos)
        {
