    ...
    internal class Program
    {
        private static void Main()
        {
            ...
            project.AddDir(new Dir(new Id("INSTALLDIR"), applicationFeature, @"%ProgramFiles%\Eyedrivomatic",
                ...
                new File($@"{eyedrivomaticTargetDir}AutoUpdater.NET.dll"),
                ...
                new File($@"{eyedrivomaticTargetDir}JetBrains.Annotations.dll"),
                ...
                new File($@"{eyedrivomaticTargetDir}NullGuard.dll"),
                ...
                new File($@"{eyedrivomaticTargetDir}System.Reactive.dll"),
                ...
                new File($@"{eyedrivomaticTargetDir}System.Runtime.InteropServices.RuntimeInformation.dll"),
