...
namespace Eyedrivomatic.Hardware
{
    ...
    {
        public static readonly Dictionary<string, HardwareIdFilter> UnoDeviceIds =
    ...
    {
        public static IEnumerable<UsbSerialDevice> EnumerateDevices([AllowNull] IList<HardwareIdFilter> filter = null)
        {
