...
public class eyedrivomatic_pure_PC_software extends PApplet {

/*
    Eyedrivomatic for pc - Version 1B
    modifications - Read com port from config file
...
public void setup (){ 
  ...
  frame.setTitle("Eyedrivomatic for PC 1B");
  

  String portName = readConfig("portName");
  Port = new Serial(this, portName, 9600); //starts the Serial port  
  Port.bufferUntil('\n'); //clean the buffer    
}
...
public String readConfig(String value) { //reads a value from the config file
  
  JSONObject json;
  String dir =  System.getenv("APPDATA");

  json = loadJSONObject(dir + "/eyedrivomatic/config.json");
  String data = json.getString(value);
  return data;
}
  public void settings() {  size (1260,790); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "eyedrivomatic_pure_PC_software" };
    if (passedArgs != null) {
