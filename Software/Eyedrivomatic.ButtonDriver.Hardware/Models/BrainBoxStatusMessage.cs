    ...
    public struct BrainBoxStatusMessage
    {
        ...
        public static BrainBoxStatusMessage BuildStatusMessage(Regex statusPattern, string message)
        {
            ...
            try
            {
                return new BrainBoxStatusMessage
                {
                    ...
                    YDriveSwitchState = (DriveStateSwitchValue)int.Parse(match.Groups[nameof(BrainBoxStatusMessage.YDriveSwitchState)].Value),
                    ...
                    XDriveSwitchState = (DriveStateSwitchValue)int.Parse(match.Groups[nameof(BrainBoxStatusMessage.XDriveSwitchState)].Value),
        ...
        public override string ToString()
        {
            return $"{nameof(ManoeuvreState)}={ManoeuvreState}, " +
                   ...
                   $"{nameof(YDriveSwitchState)}={YDriveSwitchState}, " +
                   ...
                   $"{nameof(XDriveSwitchState)}={XDriveSwitchState}, " +
